    ...
    >
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-8">
          <Link
            href="/"
            className="group flex items-center gap-0.5 text-xl font-bold tracking-tight text-foreground transition-opacity duration-200 hover:opacity-80"
          >
            Code
            <span className="bg-gradient-to-r from-brand-blue to-blue-400 bg-clip-text text-transparent">
              Bonito
            </span>
            <span className="ml-0.5 inline-block h-1.5 w-1.5 rounded-full bg-brand-amber transition-transform duration-200 group-hover:scale-125" />
          </Link>
