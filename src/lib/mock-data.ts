...
const ULTRA_PREMIUM_TEMPLATES: Template[] = [
  ...
  {
    id: "102", name: "AI Product Hero", slug: "ai-product-hero",
    description: "OpenAI/Anthropic-inspired dark landing: dot grid SVG background, morphing headline text effect, bento glassmorphism feature grid, terminal code showcase with typing animation, animated stat counters, gradient text, glowing CTA with shimmer. 4 platform variants.",
    category: "SaaS", style: "Motion", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/050510/6366f1?text=AI+Product+Hero",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/ai-product-hero",
  },
  {
    id: "103", name: "SaaS Minimal Light", slug: "saas-minimal-light",
    description: "Stripe/Linear-inspired light mode: generous whitespace, subtle gradient blobs, alternating feature rows, clean metrics with animated counters, single testimonial, minimal CTA. Proves minimal ≠ boring. 4 platform variants.",
    category: "SaaS", style: "Minimalist", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/fafafa/2563eb?text=SaaS+Minimal+Light",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/saas-minimal-light",
  },
  {
    id: "104", name: "Startup Launch", slug: "startup-launch",
    description: "YC-style startup landing: bold headline, social proof bar, problem/solution split section, browser mockup, 2-tier pricing, strong CTA. Clean, confident, conversion-focused. 4 platform variants.",
    category: "Startup", style: "Corporate", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/fafaf8/0f172a?text=Startup+Launch",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/startup-launch",
  },
  {
    id: "105", name: "Agency Dark", slug: "agency-dark",
    description: "Awwwards-style agency portfolio: massive serif typography (80-120px), mouse follower circle, asymmetric masonry portfolio grid, services marquee, clip-path text reveal, cream on black. 4 platform variants.",
    category: "Agency", style: "Luxury", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/0a0a0a/f5f0eb?text=Agency+Dark",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/agency-dark",
  },
  {
    id: "106", name: "DevTool CLI", slug: "devtool-cli",
    description: "Vercel/Railway-inspired developer tool: animated terminal with multi-step CLI typing, copyable install bar, code snippets with syntax highlighting, before/after CLI showcase, integration logos, emerald/cyan on dark. 4 platform variants.",
    category: "Tech", style: "Motion", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/09090b/10b981?text=DevTool+CLI",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/devtool-cli",
  },
  {
    id: "107", name: "Analytics Dashboard", slug: "analytics-dashboard",
    description: "Mixpanel/PostHog-inspired: full dashboard mockup with CSS bar charts, sparklines, donut chart, metric cards, bento feature grid, integration scroll strip, 3-tier pricing. Violet/blue on dark. 4 platform variants.",
    category: "Dashboard", style: "Motion", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/0c0c14/8b5cf6?text=Analytics+Dashboard",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/analytics-dashboard",
  },
  {
    id: "108", name: "App Showcase", slug: "app-showcase",
    description: "Apple-inspired mobile app landing: CSS-only phone mockups with notch/status bar, floating animation, app store buttons, screenshot carousel, review cards with star ratings, purple/pink gradients. 4 platform variants.",
    category: "Landing", style: "Motion", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/0a0a12/a855f7?text=App+Showcase",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/app-showcase",
  },
  {
    id: "109", name: "Luxury E-commerce", slug: "luxury-ecommerce",
    description: "Gucci/Aesop-inspired luxury shopping: off-white with gold accents, serif editorial typography, product grid with hover zoom overlay, horizontal scroll collection, parallax hero, elegant newsletter signup. 4 platform variants.",
    category: "E-commerce", style: "Luxury", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/faf9f6/c9a96e?text=Luxury+Ecommerce",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/luxury-ecommerce",
  },
  {
    id: "110", name: "Restaurant Premium", slug: "restaurant-premium",
    description: "Eleven Madison Park-inspired: warm dark tones, gold accents, classic menu typography with serif names and prices, geometric decorative elements, reservation form, parallax ambiance section. 4 platform variants.",
    category: "Restaurant", style: "Luxury", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/1a1410/c9a96e?text=Restaurant+Premium",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/restaurant-premium",
  },
  {
    id: "111", name: "Editorial Blog", slug: "editorial-blog",
    description: "The Verge/Monocle-inspired publication: typography-first design, featured article hero, 2-column article grid, category tabs, newsletter signup, article preview with drop cap and pullquote. Perfect reading experience. 4 platform variants.",
    category: "Blog", style: "Minimalist", platforms: ["cursor", "claude-code", "v0", "bolt", "lovable"],
    creator_id: "creator-1", price_tier: "ultra_premium", downloads_count: 0,
    preview_url: "https://placehold.co/800x600/fafaf8/dc2626?text=Editorial+Blog",
    preview_mobile_url: null, manifest_json: null, tokens_json: null, status: "published",
    created_at: new Date().toISOString(), updated_at: new Date().toISOString(), demo_url: "/demo/editorial-blog",
  },
];
